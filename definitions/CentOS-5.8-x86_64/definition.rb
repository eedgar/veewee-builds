Veewee::Session.declare({
  ...
  :disk_size => '20280', :disk_format => 'VDI', :hostiocache => 'off', :ioapic => 'on', :pae => 'on',
  :os_type_id => 'RedHat_64',
  :iso_file => "CentOS-5.8-x86_64-bin-DVD-1of2.iso", :iso_src => "", :iso_md5 => "8a3bf0030f192022943f83fe6b2cf373", :iso_download_timeout => 1000,
