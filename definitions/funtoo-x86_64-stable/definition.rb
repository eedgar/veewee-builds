Veewee::Session.declare( {
  ...
  :iso_file => "install-amd64-minimal-20120223.iso",
  :iso_src => "http://ftp.osuosl.org/pub/gentoo/releases/amd64/autobuilds/20120223/install-amd64-minimal-20120223.iso",
  :iso_md5 => "c8266af9cea1e9e2c821ed4667aa6d8a",
